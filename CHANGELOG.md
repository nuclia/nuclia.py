...
- RELEASE.md update (#268)

## 4.13.0 (2026-07-06)

### New Features

- KV schemas support (#270)
...
- bump version and publish to pypi (#277)
...
- use json parameter instead of  of data on json requests (#265)

## 4.11.3 (2026-06-16)

### Bug Fixes

- Update nuclia-models for more resilient data augmentation task parsing (#267)
